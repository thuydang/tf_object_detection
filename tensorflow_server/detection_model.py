...
# The model should be chosen for type of object to be detected.
...
MODEL_FILE_LOCAL = MODEL_STORE_PREFIX + MODEL_FILE
...
# Download Model
# TODO: check if file exists to avoid redownload!!!
opener = urllib.request.URLopener()
opener.retrieve(DOWNLOAD_BASE + MODEL_FILE, MODEL_FILE_LOCAL)
tar_file = tarfile.open(MODEL_FILE_LOCAL)
...
class Object(object):
    def __init__(self):
        self.name = "Tensorflow Object Detection"
